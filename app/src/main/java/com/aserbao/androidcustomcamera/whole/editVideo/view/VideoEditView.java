...
public class VideoEditView extends RelativeLayout implements VideoEditProgressView.PlayStateListener {
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        LayoutParams rlCurrentParams = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
        ...
        LayoutParams videoEditParams = new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.MATCH_PARENT);
        ...
        LayoutParams rlParams = new LayoutParams(DisplayUtil.dipToPx(context, 60), DisplayUtil.dipToPx(context, 60));
...
//        RelativeLayout.LayoutParams ivRarams = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, DisplayUtil.dipToPx(context, 60));
        LayoutParams ivRarams = new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.MATCH_PARENT);
