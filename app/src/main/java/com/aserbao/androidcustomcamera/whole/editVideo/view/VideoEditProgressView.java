...
public class VideoEditProgressView extends RelativeLayout {
    ...
    private LayoutParams editBarLeftParamsBar;
    private LayoutParams editBarRightParamsBar;
        ...
        if (playState) {
            ...
            if (baseImageViews != null && baseImageViews.size() > 0) {
                ...
                for (BaseImageView baseImageView : baseImageViews) {
                    ...
                    LayoutParams selectedParams = new LayoutParams(width, DisplayUtil.dipToPx( 60));
